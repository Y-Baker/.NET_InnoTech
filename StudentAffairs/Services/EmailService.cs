...
public class EmailService : IEmailService
{
    ...
    public EmailService(IConfiguration configuration, IService service)
    {
    ...
    
    {
        ...
        if (_configuration["Admin"] is not null)
        {
            await SendEmail(_configuration["Admin"]!, "New Survey Submission", emailContent);
        }
